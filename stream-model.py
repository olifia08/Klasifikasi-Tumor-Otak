...
if menu == "Home":
    ...
    if cgga_df is not None:
        ...
        st.dataframe(cgga_df.describe())
                # Path gambar
        chart_age_path = r"D:\UTM Teknik Informatika\Semester 5\PSD\UAS\PSD_Olif\Deploy\chart_age.png"
        chart_grade_path = r"D:\UTM Teknik Informatika\Semester 5\PSD\UAS\PSD_Olif\Deploy\chart_grade.png"
